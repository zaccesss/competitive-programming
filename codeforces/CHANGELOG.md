...
- Badge row normalised to flat shields, dropping the chunky Portfolio, LinkedIn, Email and Codeforces badges.
- Removed the remaining emoji from the footer.
- Added a Contact and Support section.
