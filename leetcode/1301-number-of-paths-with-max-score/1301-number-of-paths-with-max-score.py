class Solution:
    def pathsWithMaxScore(self, board: List[str]) -> List[int]:
        ...
        # started from S with a score of 0 and one valid path.
        dpScore[n - 1][n - 1] = 0
        dpWays[n - 1][n - 1] = 1

        # processed the board from bottom-right to top-left.
        for row in range(n - 1, -1, -1):
            for col in range(n - 1, -1, -1):
                ...
                # checked the three possible moves:
                ...
                # skipped cells that cannot reach S.
                if bestScore == -1:
                    continue

                # added the value of the current cell.
                value = 0
