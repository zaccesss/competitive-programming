...
| ---------- | -------------------------------------------------------------------------- | ---------- | ------------- | -------------------------------------------------- |
| LeetCode   | [leetcode.com/u/zacadjei](https://leetcode.com/u/zacadjei)                 | `zacadjei` | `leetcode/`   | interview practice, daily problems, algorithm reps |
| Codeforces | [codeforces.com/profile/zaccesss](https://codeforces.com/profile/zaccesss) | `zaccesss` | `codeforces/` | contest prep, rating progress, timed practice      |
| NeetCode   | [neetcode.io/profile/zaccess](https://neetcode.io/profile/zaccess)         | `zaccess`  | `neetcode/`   | roadmap tracking, curated interview patterns       |
